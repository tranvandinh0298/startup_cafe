...
class CreateIngredientsTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('ingredients', function (Blueprint $table) {
            ...
            $table->integer("shelf_life_closed_days")->comment("Hạn sử dụng khi chưa mở gói, tính theo ngày");
            $table->integer("shelf_life_opened_hours")->comment("Hạn sử dụng khi đã mở gói, tính theo giờ");
