...
class CreateInventoryBatchesTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('inventory_batches', function (Blueprint $table) {
            ...
            $table->dateTime('opened_at')->nullable()->comment('Thời điểm mở bao bì');
            $table->dateTime('expired_at')->nullable()->comment("Hạn sử dụng sau khi mở bao bì = shelf_life_opened_hours + opened_at");
